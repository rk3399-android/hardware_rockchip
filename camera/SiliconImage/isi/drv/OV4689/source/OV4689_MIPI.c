...
#define OV4689_SLAVE_ADDR       0x6cU                           /**< i2c slave address of the OV4689 camera sensor */ //* if SID is high, the sensor's I2C address comes from reg.0X3012 which has a default value of 0x20 */
#define OV4689_SLAVE_ADDR2      0x20U					  // if SID is low, the sensor's I2C address comes from reg.0X3004 which has a default value of 0x6C 
